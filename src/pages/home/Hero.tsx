  ...
  return (
    <div className='relative'>
      <div className='absolute top-1/2 transform -translate-y-1/2 ps-4 md:ps-6 lg:ps-8 xl:ps-10'>
        ...
        xl:text-[24px] font-open xl:font-semibold text-gray'>Sadece geçerli süreyle</p>
        <h1 className='text-[20px] sm:text-[25px] lg:text-[50px]
        xl:text-[74px] font-semibold text-white'>
          %30 indirim</h1>
        <p className='font-open text-[10px] sm:text-[12]
